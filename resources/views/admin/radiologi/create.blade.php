<x-app-layout>
    <div>
        ...
        <div class="mb-6 flex justify-between items-center">
            <div>
                <h2 class="text-3xl font-bold text-gray-900">Tambah Hasil Radiologi</h2>
                <p class="mt-1 text-sm text-gray-500">Input hasil pemeriksaan radiologi</p>
            </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <form method="POST" action="{{ route($prefix . '.radiologi.store') }}" class="space-y-4">
                @csrf
