<x-app-layout>
    <div>
        ...
        <div class="mb-6 flex justify-between items-center">
            <div>
                <h2 class="text-3xl font-bold text-gray-900">Radiologi</h2>
                <p class="mt-1 text-sm text-gray-500">Kelola hasil pemeriksaan radiologi</p>
            </div>
            @can('radiologi.create')
                <a href="{{ route($prefix . '.radiologi.create') }}"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $item->dokter->user->name ?? '-' }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm space-x-3 flex">
                                        <a href="{{ route($prefix . '.radiologi.show', $item) }}" title="Lihat"
                                        ...
                                        @can('radiologi.edit')
                                            <a href="{{ route($prefix . '.radiologi.edit', $item) }}" title="Edit"
                                        ...
                                        @endcan
                                        @can('radiologi.delete')
                                            <form action="{{ route($prefix . '.radiologi.destroy', $item) }}" method="POST" class="delete-form inline">
                                                @csrf
                                                @method('DELETE')
