<x-app-layout>
    <div>
        <div class="mb-6">
            <h2 class="text-3xl font-bold text-gray-900">Tambah Data Dokter</h2>
            <p class="mt-1 text-sm text-gray-500">Daftarkan dokter baru</p>
        </div>

        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('admin.dokter.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
