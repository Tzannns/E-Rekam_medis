<x-app-layout>
    <div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg mb-6 p-6">
            <form method="GET" action="{{ route('admin.igd.index') }}" class="space-y-4">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.igd.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        Reset
                    </a>
                </div>
            </form>
                        ...
                        @forelse ($igds as $igd)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm space-x-3 flex">
                                    <a href="{{ route('admin.igd.show', $igd) }}" title="Lihat"
                                    ...
                                    @can('igd.edit')
                                        <a href="{{ route('admin.igd.edit', $igd) }}" title="Edit"
                                    ...
                                    @endcan
                                    @can('igd.delete')
                                        <form action="{{ route('admin.igd.destroy', $igd) }}" method="POST"
