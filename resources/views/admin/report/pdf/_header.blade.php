...
<div style="display:flex; align-items:center; gap:12px; margin-bottom:12px;">
    <div style="flex:0 0 24mm; display:flex; align-items:center; justify-content:center;">
        <img src="{{ $logoPath }}" alt="Logo" style="height:24mm; width:auto; display:block; object-fit:contain; image-rendering:crisp-edges;" />
    </div>
    <div style="flex:1;">
        <div style="font-size:16px; font-weight:700; text-transform:uppercase;">{{ $settings->nama_instansi ?? 'POLITEKNIK UNGGULAN KALIMANTAN' }}</div>
