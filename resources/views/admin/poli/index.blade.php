    ...
    <div>
        <div class="mb-6 flex justify-between items-center">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Kelola data poli/poliklinik</p>
            </div>
                        ...
                        @forelse ($polis as $poli)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm space-x-3 flex">
                                    <a href="{{ route('admin.poli.show', $poli) }}" title="Lihat"
                                    ...
                                    <a href="{{ route('admin.poli.edit', $poli) }}" title="Edit"
                                    ...
                                    <form action="{{ route('admin.poli.destroy', $poli) }}" method="POST"
