    ...
    <div>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                ...
                <a href="{{ route('petugas.rawat-inap.index') }}"
                ...
                <a href="{{ route('petugas.kasir.index') }}"
                ...
                <a href="{{ route('petugas.storage.index') }}"
                ...
                <a href="{{ route('petugas.apotik.index') }}"
                ...
                <a href="{{ route('petugas.laboratorium.index') }}"
                ...
                <a href="{{ route('petugas.radiologi.index') }}"
                ...
                <a href="{{ route('petugas.gizi.index') }}"
                ...
                <a href="{{ route('petugas.laundry.index') }}"
                ...
                <a href="{{ route('petugas.appointment.index') }}"
                    class="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow duration-200 flex items-center cursor-pointer border border-gray-200 hover:border-yellow-300">
                    <div class="flex-shrink-0">
                        <div class="w-12 h-12 bg-yellow-100 rounded-lg flex items-center justify-center">
                            <svg class="w-6 h-6 text-yellow-600" fill="none" stroke="currentColor"
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Total Appointment</dt>
                                    <dd class="text-lg font-medium text-gray-900">{{ $totalAppointment }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $appointmentMenunggu }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        @forelse($recentRekamMedis as $rekam)
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ $rekam->tanggal_periksa->format('d M Y') }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ $rekam->pasien->user->name }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ $rekam->dokter->user->name }}</td>
                                <td class="px-6 py-4 text-sm text-gray-900">{{ Str::limit($rekam->diagnosa, 50) }}
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-4 text-center text-sm text-gray-500">Belum ada rekam
                                    medis</td>
                            </tr>
                        @endforelse
                    </tbody>
