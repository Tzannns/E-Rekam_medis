    ...
    <div>
        ...
        <div class="max-w-4xl">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('petugas.rekam-medis.update', $rekamMedi) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <select name="pasien_id" id="pasien_id" required
                                ...
                                @foreach ($pasienList as $pasien)
                                    <option value="{{ $pasien->id }}"
                                        {{ $rekamMedi->pasien_id == $pasien->id ? 'selected' : '' }}>
                                        {{ $pasien->user->name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select name="dokter_id" id="dokter_id" required
                                ...
                                @foreach ($dokterList as $dokter)
                                    <option value="{{ $dokter->id }}"
                                        {{ $rekamMedi->dokter_id == $dokter->id ? 'selected' : '' }}>
                                        {{ $dokter->user->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="tanggal_periksa" class="block mt-1 w-full" type="date"
                                name="tanggal_periksa" :value="$rekamMedi->tanggal_periksa->format('Y-m-d')" required />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="keluhan" name="keluhan" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('keluhan', $rekamMedi->keluhan) }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="diagnosa" name="diagnosa" rows="3" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('diagnosa', $rekamMedi->diagnosa) }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="tindakan" name="tindakan" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('tindakan', $rekamMedi->tindakan) }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="resep_obat" name="resep_obat" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('resep_obat', $rekamMedi->resep_obat) }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="catatan" name="catatan" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('catatan', $rekamMedi->catatan) }}</textarea>
