    ...
    <div>
        ...
        <div class="max-w-4xl">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('petugas.rekam-medis.store') }}">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="tanggal_periksa" class="block mt-1 w-full" type="date"
                                name="tanggal_periksa" :value="old('tanggal_periksa')" required />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="keluhan" name="keluhan" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('keluhan') }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="diagnosa" name="diagnosa" rows="3" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('diagnosa') }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="tindakan" name="tindakan" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('tindakan') }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="resep_obat" name="resep_obat" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('resep_obat') }}</textarea>
