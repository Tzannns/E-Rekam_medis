    ...
    <div>
        <div class="mb-6 flex justify-between items-center">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Tinjau dan kelola antrian</p>
            </div>
            <a href="{{ route('petugas.appointment.index') }}" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition">Kembali</a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('petugas.appointment.update', $appointment) }}" class="space-y-4">
                    @csrf
                    @method('PUT')
                    <div>
