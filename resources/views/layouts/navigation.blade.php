            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(auth()->user()->hasRole('Admin'))
                        ...
                        <x-nav-link :href="route('admin.rekam-medis.index')" :active="request()->routeIs('admin.rekam-medis.*')">
                            {{ __('Rekam Medis') }}
                        </x-nav-link>
                    ...
                    @elseif(auth()->user()->hasRole('Pasien'))
                        ...
                        <x-nav-link :href="route('pasien.rekam-medis.index')" :active="request()->routeIs('pasien.rekam-medis.*')">
                            {{ __('Riwayat Medis') }}
                        </x-nav-link>
                    @else
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(auth()->user()->hasRole('Admin'))
                ...
                <x-responsive-nav-link :href="route('admin.rekam-medis.index')" :active="request()->routeIs('admin.rekam-medis.*')">
                    {{ __('Rekam Medis') }}
                </x-responsive-nav-link>
            ...
            @elseif(auth()->user()->hasRole('Pasien'))
                ...
                <x-responsive-nav-link :href="route('pasien.rekam-medis.index')" :active="request()->routeIs('pasien.rekam-medis.*')">
                    {{ __('Riwayat Medis') }}
                </x-responsive-nav-link>
            @else
