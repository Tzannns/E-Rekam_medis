...
class PendaftaranController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.pendaftaran.index')->with('success', 'Pasien berhasil didaftarkan ke sistem');
        } catch (\Exception $e) {
            // If error occurs, delete the user that was just created
            if (isset($user)) {
                $user->delete();
            }
